...
\section{Introduction}
  ...
  $\SL_2$-tilings can also be viewed as $T$-systems of type $A_1$ (as in, for instance, \cite{DiFrancescoKedem}), where all variables are evaluated in positive integers.
