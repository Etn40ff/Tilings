...
\section{$\SL_2$-Tilings of the Plane}
  ...
  An interpretation of all possible $\SL_2$-tilings was later given in \cite{HolmJorgensen} in terms of triangulations of a polygon with infinitely many vertices.
...
\begin{thebibliography}{99}
  ...
  \bibitem{HolmJorgensen} Thorsten Holm and Peter J\o rgensen, \emph{$\SL_2$-tilings and triangulations of the strip}, J. Combin. Theory Ser. A {\bf 120} (2013), 1817-1834.
\end{thebibliography}
