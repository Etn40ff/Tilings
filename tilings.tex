...
\section{$\fsl_2$-Tilings of the Plane}
  ...
  The following anti-$\fsl_2$-tiling will be relevant in our higher dimensional analysis.
  We will call it the \emph{staircase} anti-$\fsl_2$-tiling of $\ZZ^2$.
  \begin{example}\label{ex:Fibonacci}
    Consider the anti-$\fsl_2$-tiling $(a_{ij})_{i,j\in\ZZ}$ of $\ZZ^2$ with $a_{ij}=1$ if $i+j\in\{0,1\}$.  
...
\section{$\fsl_2$-Tilings in Higher Dimensions}
  ...
  \begin{lemma}\label{le:constant slices}
    Let $n\ge 3$ and assume $(a_{\bi})_{\bi\in\ZZ^n}$ is either an $\fsl_2$-tiling or an anti-$\fsl_2$-tiling of $\ZZ^n$.
  ...
  \begin{theorem} 
    ...
    Any of its ``two dimensional slices'' obtained by fixing all but two of the coordinates of $\bi$ is a translation of the staircase anti-$\fsl_2$-tiling of $\ZZ^2$ from Example \ref{ex:Fibonacci}.
  ...
  \begin{corollary}\label{co:n=3}
    For $n=3$, there are precisely $4$ signature matrices $\bepsilon$ for which there exists an $\bepsilon$-$\fsl_2$-tiling. 
    For such $\bepsilon$ this $\bepsilon$-$\fsl_2$-tiling is unique (up to translation).
    More precisely, an $\bepsilon$-$\fsl_2$-tiling exists if and only if $\epsilon_{12}\epsilon_{13}\epsilon_{23}=-1$.
  \end{corollary}
  \begin{proof}
  ...
  \end{theorem}
  \begin{proof}
    Let $(a_{\bi})_{\bi\in\ZZ^n}$ be an $\bepsilon$-$\fsl_2$-tiling of $\ZZ^n$. 
    Fixing all but any three distinct coordinates  $j,k,\ell$ of $\bi$, gives a tiling of $\ZZ^3$.
    Therefore, by Corollary \ref{co:n=3}, we have an inclusion $E \subset E'$ where $E$ is the set of $n\times n$ signature matrices which admit an $\bepsilon$-$\fsl_2$-tiling and $E'$ is the set of $n\times n$ signature matrices $\bepsilon$ satisfying $\bepsilon_{jk} \bepsilon_{k\ell} \bepsilon_{j\ell} = -1$ for any triple of distinct indices.
  ...
  \begin{remark}
    It is now clear why we choose the diagonal entries of $\bepsilon$ to be equal to $-1$: any $\bepsilon$-$\fsl_2$-tiling consists of odd Fibonacci numbers and \eqref{eq:higher sl2 recursion} is satisfied also for $k=\ell$.
  \end{remark} 
